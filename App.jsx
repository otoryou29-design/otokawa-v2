          ...
          <div style={{display:"grid",gap:18}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:12}}>
              ...
              <div style={{display:"flex",alignItems:"center",gap:8,background:"#fff",border:"2px solid #dde5de",borderRadius:11,padding:"8px 14px"}}>
                ...
                <input type="date" value={boardDate} onChange={e=>{
                  const newDate=e.target.value
                  setBoardDate(newDate)
                  dbSet("boardDate",newDate)
                  // 日付が変わったらメッセージをリセット
                  const empty={board_all:"",board_cmg:"",board_smg:""}
                  setBoardMessages(empty)
                  dbSet("boardMessages",empty)
                  setBoardUpdated({})
                }} style={{border:"none",background:"transparent",width:"auto",padding:"2px 4px",fontSize:14,fontWeight:700}}/>
              </div>
            </div>
            {[
